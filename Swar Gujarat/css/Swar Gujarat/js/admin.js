...
document.addEventListener('DOMContentLoaded', () => {
    ...
    async function renderManageList() {
        ...
        document.querySelectorAll('.edit-btn').forEach(btn => {
            ...
            btn.addEventListener('mouseover', (e) => { e.target.style.background = 'rgba(255, 255, 255, 0.2)'; });
            btn.addEventListener('mouseout', (e) => { e.target.style.background = 'rgba(255, 255, 255, 0.1)'; });
        });
        ...
        document.querySelectorAll('.delete-btn').forEach(btn => {
            ...
            btn.addEventListener('mouseover', (e) => { e.target.style.background = 'rgba(255, 82, 82, 0.3)'; });
            btn.addEventListener('mouseout', (e) => { e.target.style.background = 'rgba(255, 82, 82, 0.15)'; });
        });
    }
